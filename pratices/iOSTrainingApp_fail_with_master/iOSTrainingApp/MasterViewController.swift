...
//        self.navigationItem.rightBarButtonItem = addButton
        ...
        // load products in plist
        let plistPath = NSBundle.mainBundle().pathForResource("Products", ofType: "plist")
        self.productList = NSArray(contentsOfFile: plistPath!)
    }
...
//        return sectionInfo.numberOfObjects
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        var cell:UITableViewCell! = tableView.dequeueReusableHeaderFooterViewWithIdentifier(cellIdentifier) as? UITableViewCell
        if (cell == nil){
            cell = UITableViewCell(style: UITableViewCellStyle.Default, reuseIdentifier: cellIdentifier)
        }
        
        let row = indexPath.row
        let rowDict = self.productList[row] as! NSDictionary
